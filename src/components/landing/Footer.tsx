...
export function Footer() {
  return (
    <footer
      className="relative h-[446px] w-full"
      ...
      <div className="absolute left-[120px] top-16 flex w-[1200px] flex-col gap-10">
        <div className="flex flex-col gap-6">
          ...
          <p className="text-[15px] font-normal leading-6 text-white/75">
            ...
            Connecting primary agricultural cooperatives, energy reservoirs, and mineral concessions
            directly to global industrial markets.
          </p>
        </div>
